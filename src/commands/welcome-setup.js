...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub => sub
      .setName('enable')
      .setDescription('Enable the welcome card in a channel')
      .addChannelOption(o => o.setName('channel').setDescription('Channel to send welcome cards in').setRequired(true))
      .addStringOption(o => o.setName('message').setDescription('Welcome message (use {user}, {server}, {membercount})').setRequired(false))
    )
    .addSubcommand(sub => sub
      .setName('disable')
