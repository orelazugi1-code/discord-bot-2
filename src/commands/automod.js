...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addBooleanOption(o => o.setName('links').setDescription('Enable/disable link filter (all URLs)'))
    .addBooleanOption(o => o.setName('invites').setDescription('Enable/disable Discord invite link filter'))
  ...
  async execute(interaction, db) {
    ...
    const hasChanges = spam !== null || links !== null || invites !== null || mentions !== null ||
                       maxMentions !== null || addWord || removeWord;
      ...
      return interaction.reply({
        embeds: [new EmbedBuilder()
          ...
          .addFields(
            ...
            { name: 'Invite Filter',  value: cfg.anti_invite_enabled    ? '✅ On' : '❌ Off', inline: true },
    ...
    if (invites  !== null) updates.anti_invite_enabled    = invites  ? 1 : 0;
