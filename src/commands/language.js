...
module.exports = {
  data: new SlashCommandBuilder().setName('language').setDescription('שנה את שפת הבוט אצלך')
    .addStringOption(o => o.setName('lang').setDescription('בחר שפה').setRequired(true)
